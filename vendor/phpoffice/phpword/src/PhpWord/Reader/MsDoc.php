...
class MsDoc extends AbstractReader implements ReaderInterface
{
    ...
    {
        return ord(isset($data[$pos])?$data[$pos]:'');
    }
    ...
    {
        return ord(isset($data[$pos])?$data[$pos]:'') | (ord(isset($data[$pos + 1])?$data[$pos + 1]:'') << 8);
    }
    ...
    {
        return ord(isset($data[$pos])?$data[$pos]:'') | (ord(isset($data[$pos + 1])?$data[$pos + 1]:'') << 8) | (ord(isset($data[$pos + 2])?$data[$pos + 2]:'') << 16);
    }
    ...
    public static function getInt4d($data, $pos)
    {
        ...
        return ord(isset($data[$pos])?$data[$pos]:'') | (ord(isset($data[$pos + 1])?$data[$pos + 1]:'') << 8) | (ord(isset($data[$pos + 2])?$data[$pos + 2]:'') << 16) | $ord24;
    }
}
