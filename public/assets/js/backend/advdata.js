define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'advdata/index' + location.search,
                    add_url: 'advdata/add',
                    edit_url: 'advdata/edit',
                    del_url: 'advdata/del',
                    multi_url: 'advdata/multi',
                    import_url: 'advdata/import',
                    table: 'advdata',
                }
            });
            ...
            table.bootstrapTable({
                ...
                columns: [
                    [
                        ...
                        {field: 'advtype_id', title: __('Advtype_id'),visible:false},
                        {field: 'advtype.name', title: __('Advtype.name'), operate: 'LIKE'},
                        ...
                        {field: 'hit', title: __('Hit'),visible:false},
        ...
        recyclebin: function () {
            ...
            // 初始化表格
            table.bootstrapTable({
                url: 'advdata/recyclebin' + location.search,
                pk: 'id',
                sortName: 'id',
                columns: [
                    [
