...
return [
    ...
    'lang_switch_on'         => true,
    // 默认全局过滤方法 用逗号分隔多个
    'default_filter'         => 'addslashes,htmlspecialchars,trim',
    // 默认语言
    'default_lang'           => 'zh-cn',
    // 应用类库后缀
    'class_suffix'           => false,
    ...
    'dispatch_success_tmpl'  => APP_PATH . 'index' . DS . 'view' . DS . 'common' . DS . 'jump.html',
//    'dispatch_error_tmpl'    => APP_PATH . 'common' . DS . 'view' . DS . 'tpl' . DS . 'dispatch_jump.tpl',
    'dispatch_error_tmpl'  => APP_PATH . 'index' . DS . 'view' . DS . 'common' . DS . 'jump.html',
    // +----------------------------------------------------------------------
    // | 异常及错误设置
    // +----------------------------------------------------------------------
    // 异常页面的模板文件
//    'exception_tmpl'         => APP_PATH . 'common' . DS . 'view' . DS . 'tpl' . DS . 'think_exception.tpl',
    'exception_tmpl'        => APP_PATH . 'index' . DS . 'view' . DS . 'common' . DS . 'error.html',
    // 错误显示信息,非调试模式有效
    ...
    'token'                  => [
        ...
        'type'     => 'Mysql',
        // 缓存前缀
        'key'      => 'TMBoSpUxLvsGwg9aX8Jrl30FQA1dqkWf',
        // 加密方式
        'hashalgo' => 'ripemd160',
        // 缓存有效期 0表示永久缓存
        'expire'   => 0,
